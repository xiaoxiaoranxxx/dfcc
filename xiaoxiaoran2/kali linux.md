...
![image-20220328193801071](https://xiuxiu-1306082599.cos.ap-beijing.myqcloud.com/xiao/202203282246854.png)
...
![image-20220328195251957](https://xiuxiu-1306082599.cos.ap-beijing.myqcloud.com/xiao/202203282246056.png)
...
![image-20220328201044106](https://xiuxiu-1306082599.cos.ap-beijing.myqcloud.com/xiao/202203282246766.png)



为什 么我在任何目录下输入 ls 就一定可以显示出一些讯息而不会说找不到该 /bin/ls 指令呢？ 这是 
...
![image-20220328202956270](https://xiuxiu-1306082599.cos.ap-beijing.myqcloud.com/xiao/202203282246074.png)
...
```
 find  /home -mtime 0     将过去系统上面 24 小时内有更动过内容 （mtime） 的文件列出
 
 find  /home -user root    搜寻 /home 下面属于 root 的文件
  
 find  /home -name *.py    找出  py 文件
 
 find  /home -type f       目录下，文件类型为 f 的文件名有哪些  一般正规文件 （f）, 设备文件 （b, c）, 目录 （d）, 链接文件 （l）, socket （s）, 及 FIFO （p）
```
